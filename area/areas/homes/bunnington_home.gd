...
func wake_up_dialogue():
	...
	kate_bunnginton.display_dialogue(["Wakey wakey! You have a big day ahead of you!", "It was 10 years ago today that your great grandfather founded this town.", "Every year, on the anniversery of Bunnyville, a town member is elected to gather 5 carrots and place them on his alter in his memory.", "This year, that bunny is you!", "But before you go, come talk to me. I have an errand for you to run."])
